        ...
        children: [
          ...
          Padding(
            ...
            child: Align(
              ...
              child:
                  Text("Requests", style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
            ),
          ),
    ...
    children: [
      TabBar(
        ...
        tabs: [
          ...
          Tab(child: Text('Approvals', style: TextStyle(
            fontSize: 11,color: Color.fromRGBO(115, 114, 114, 1)))),
          Tab(child: Text('Ongoing', style: TextStyle(
            fontSize: 11,
                        ...
                        child: const Row(
                          children: [
                            Padding(
                              ...
                              child: Text("Laptop repair",style: TextStyle(
                                fontSize: 12
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("No:4 West Kalmandapam Road",
                     ...
                     Padding(
                       ...
                       child: Text("Royapuram,Chennai-600013",
                            style: TextStyle(fontSize: 10,fontWeight: FontWeight.w400),),
                     ),
                     ...
                     Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 5),
                          child: Text("Get Directions",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600,color: Color.fromRGBO(68, 109, 222, 1)),),
                        ),
                        Spacer(),
     ...
     child: Container(
      ...
      child: TextField(
        decoration: InputDecoration(
         suffix: Text("Verify",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600,color: Colors.black),),
          hintText: 'Enter 6 Digit Otp',
          contentPadding: EdgeInsets.all(10.0), // Optional: Adjust padding
